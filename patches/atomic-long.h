...
// Include headers needed just for type definitions visible outside the guard

// Provide basic types/init macros needed outside the guard,
// guarded in case asm-generic/atomic-long.h is somehow included before this.
#ifndef __ASM_GENERIC_ATOMIC_LONG_H
  #ifdef CONFIG_64BIT
  ...
  #endif
#endif // __ASM_GENERIC_ATOMIC_LONG_H

// Define atomic_long_t type based on CONFIG_64BIT
#ifdef CONFIG_64BIT
...
// --- Exclude ALL inline functions and their includes during COMPILE_TEST ---
#ifndef COMPILE_TEST

  // Includes needed for the actual function implementations
  #include <asm-generic/atomic-long.h> // Include again here for safety if needed by functions
  ...
  // --- Start of weak raw_atomic64_* definitions ---
    ...
    #endif
  // --- End of weak raw_atomic64_* definitions ---


  // --- Start of raw_atomic_long_* functions ---
  #ifdef CONFIG_64BIT
  ...
  #endif /* CONFIG_64BIT */
  // --- End of raw_atomic_long_* functions ---

#endif // <<<=== END GUARD (for COMPILE_TEST)
